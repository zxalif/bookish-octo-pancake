...
class User(Base, TimestampMixin):
    ...
    is_admin = Column(Boolean, default=False, nullable=False, index=True)  # Admin role for admin panel access
    is_banned = Column(Boolean, default=False, nullable=False, index=True)  # Ban status - banned users cannot login
